...
REPRESENTATIONS = {'imperfect': '(παρατατικός)<br>----    |',
                   ...
                   'aorist': '(ἀορίστος χρόνος)<br>-   |',
                   'future perfect': '(τετελέσμενος μέλλων)<br>|    ----    X',
                   'indicative': '(ὁριστηκὴ ἔνκλισις)<br>👉 ',
                   'imperative': '(προστακτικὴ ἔνκλισις)<br>✋ ',
                   'subjunctive': '(ὑποτακτικὴ ἔνκλισις)<br>ἄν',
                   'optative': '(εὐτικὴ ἔνκλισις)<br>εἰ',
                   '1st': '(πρῶτον πρόσωπον)<br>ἐγώ',
                   '2nd': '(δεύτερον πρόσωπον)<br>σύ',
                   '3rd': '(τρίτον πρόσωπον)<br>ἐκείνω',
                   '2nd dual': '(δεύτερον δυϊκον πρόσωπον)<br>σφώ',
                   '3rd dual': '(τρίτον δυϊκον πρόσωπον)',
                   '1st plural': 'ἡμεῖς',
                   '2nd plural': 'ὑμεῖς',
                   '3rd plural': 'σφεῖς',
                   'infinitive': '(ἀπαρεμφάτος ἔγκλισις)<br>∞',
